...
rem 更新软件库文件
curl -fo "%PROGRAMFILES(X86)%\Tencent\QQPCMgr\{版本号}\GlobalConfig.etf" -L https://cdn.jsdelivr.net/gh/DustinWin/softmanager@QQPCSoftMgr/GlobalConfig.etf
curl -fo "%PROGRAMFILES(X86)%\Tencent\QQPCMgr\{版本号}\SoftPolicy.etf" -L https://cdn.jsdelivr.net/gh/DustinWin/softmanager@QQPCSoftMgr/SoftPolicy.etf
curl -fo "%PROGRAMFILES(X86)%\Tencent\QQPCMgr\{版本号}\SoftVerInfo.etf" -L https://cdn.jsdelivr.net/gh/DustinWin/softmanager@QQPCSoftMgr/SoftVerInfo.etf
echo 更新软件库文件成功
pause
```
